...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <section id="comments" class="content-wrap container" itemscope itemtype="http://schema.org/Comment">
            <?php if (post_password_required()) : ?>
                <p class="nopassword"><?php _e('Esta publicação está protegida por senha. Digite a senha para ver todos os comentários.', 'Pacto Administradora'); ?></p>
            </section><!-- #comments -->
            <?php
            return;
        endif;
        ...
        if (have_comments()) :
            ...
            <?php if (get_comment_pages_count() > 1 && get_option('page_comments')) : ?>
                <nav id="comment-nav-above">
                    <ul class="pager">
                        <li class="previous"><?php previous_comments_link(__('&larr; todos os Comentários', 'Pacto')); ?></li>
                        <li class="next"><?php next_comments_link(__('Novos Comentários &rarr;', 'Pacto')); ?></li>
                    </ul>
                </nav>
            <?php endif; ?>
            <ul class="media-list">
            ...
            <div class="col-lg-8 col-md-12 col-sm-12">
                <?php if (get_comment_pages_count() > 1 && get_option('page_comments')) : ?>
                    <nav id="comment-nav-above">
                        <ul class="pager">
                            <li class="previous"><?php previous_comments_link(__('&larr; Todos os Comentários', 'Pacto')); ?></li>
                            <li class="next"><?php next_comments_link(__('Novos Comentários &rarr;', 'odin')); ?></li>
                        </ul>
                    </nav>
                <?php endif; ?>
            </div>
        ...
        <div class="col-lg-8 col-md-12 col-sm-12">
            <?php if (!comments_open() && post_type_supports(get_post_type(), 'comments')) : ?>
                <p class="nocomments"><?php _e('Comentários Fechados.', 'Pacto Administradora'); ?></p>
            <?php endif; ?>
        </div>
        <div class="col-lg-8 col-md-12 col-sm-12">
            <?php
            ...
            $fields = array(
                'author' => '<div class="comment-form-author form-group">' . '<label for="author">' . __('Nome', 'odin') . ( $req ? ' <span class="required text-danger">*</span>' : '' ) . '</label> ' .
            ...
            comment_form(array(
                ...
                'class_submit' => 'submit btn btn-primary buttomComment'
            ));
            ?>
        </div>
        </section><!-- #comments -->
